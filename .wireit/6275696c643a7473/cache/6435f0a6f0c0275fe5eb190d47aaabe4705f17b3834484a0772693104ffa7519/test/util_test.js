...
import { MergedAsyncIterables, relativeUrlPath, resolveUrlPath, classifySpecifier, parseNpmStyleSpecifier, fileExtension, changeFileExtension, charToLineAndChar, } from '../typescript-worker/util.js';
suite('MergedAsyncIterables', () => {
    const flush = async (iterable) => {
        const results = [];
