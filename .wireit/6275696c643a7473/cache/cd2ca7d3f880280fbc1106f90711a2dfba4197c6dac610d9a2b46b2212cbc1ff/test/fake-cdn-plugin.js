...
export function fakeCdnPlugin() {
    ...
    return {
        ...
        serve(ctx) {
            ...
            const semverRange = semverRangeOrTag === '' || semverRangeOrTag === 'latest'
                ? '*'
                : semverRangeOrTag;
            ...
            if (path === '') {
                const packageJson = JSON.parse((_b = (_a = versionData.files['package.json']) === null || _a === void 0 ? void 0 : _a.content) !== null && _b !== void 0 ? _b : '{}');
                ...
                const main = (_c = packageJson.main) !== null && _c !== void 0 ? _c : 'index.js';
                ctx.response.status = 302;
            ...
            if (file !== undefined) {
                ctx.response.status = (_d = file.status) !== null && _d !== void 0 ? _d : 200;
...
const parseNpmModuleSpecifier = (specifier) => {
