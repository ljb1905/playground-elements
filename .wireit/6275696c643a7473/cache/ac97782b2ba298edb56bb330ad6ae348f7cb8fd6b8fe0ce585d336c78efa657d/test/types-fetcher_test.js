...
const checkTypesFetcherImpl = async (opts, cdnBaseUrl) => {
    var _a, _b;
    const cdn = new CachingCdn(cdnBaseUrl);
    const importMapResolver = new ImportMapResolver((_a = opts.importMap) !== null && _a !== void 0 ? _a : {});
    const actual = await TypesFetcher.fetchTypes(cdn, importMapResolver, opts.packageJson, opts.sourceTexts, (_b = opts.tsLibs) !== null && _b !== void 0 ? _b : []);
    ...
    assert.deepEqual([...actual.files].sort(([keyA], [keyB]) => keyA.localeCompare(keyB)), [...opts.expectedFiles].sort(([keyA], [keyB]) => keyA.localeCompare(keyB)));
};
suite('types fetcher', () => {
    ...
    test('no dependencies', async () => {
        const sourceTexts = [`export const foo = "foo";`];
        const packageJson = {};
        const cdnData = {};
        const expectedFiles = new Map();
        const expectedDependencyGraph = {
    ...
    test('only direct dependencies', async () => {
        ...
        //   v    v
        //  A1    B2
        const sourceTexts = [`import 'a';`, `import 'b';`];
        const packageJson = {
            dependencies: {
                a: '^1.0.0',
                b: '^1.0.0',
    ...
    test('import map: specifier includes filename', async () => {
        const sourceTexts = [`import {foo} from 'foo/foo.js';`];
        const packageJson = {};
        const cdnData = {
            foo: {
                versions: {
