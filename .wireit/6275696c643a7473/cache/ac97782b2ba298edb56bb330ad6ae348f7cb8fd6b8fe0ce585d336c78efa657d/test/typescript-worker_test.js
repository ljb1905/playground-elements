    ...
    test('emits semantic error from bare module', async () => {
        ...
        const expected = [
            ...
            },
            {
                ...
                file: {
                    name: 'index.js',
                    content: 'import { strFn } from "./node_modules/foo@2.0.0/index.js";\r\nimport { numFn } from "./node_modules/foo@2.0.0/bar.js";\r\nstrFn(123);\r\nnumFn("str");\r\n',
                    contentType: 'text/javascript',
                },
            },
            {
    ...
    test('respects package.json dependency for semantic errors', async () => {
        ...
        const expected = [
            ...
            },
            {
                ...
                file: {
                    name: 'index.js',
                    content: 'import { foo } from "./node_modules/foo@1.0.0/index.js";\r\nfoo(123);\r\n',
                    contentType: 'text/javascript',
                },
            },
            {
        ...
        const expected = [
            {
                ...
                file: {
                    name: 'index.js',
                    content: 'import { num } from "./node_modules/foo@1.0.0/index.js";\r\nimport { str } from "./node_modules/str-or-num@1.0.0/index.js";\r\nconst a = str;\r\nconst b = num;\r\n',
                    contentType: 'text/javascript',
                },
            },
            {
