...
suite('bare module worker', () => {
    ...
    test('non-existent dependency', async () => {
        ...
        const expected = [
            ...
            {
                diagnostic: {
                    message: 'Could not resolve module "non-existent/index.js": CDN HTTP 404 error (<CDN-BASE-URL>/non-existent@latest/package.json): Not Found',
                    range: {
                        end: {
                            character: 29,
                            line: 0,
                    ...
                    message: 'Invalid package.json: ' +
                        {
                            ...
                            firefox: 'SyntaxError: JSON.parse: unexpected character at line 2 column 28 of the JSON data',
                            safari: 'SyntaxError: JSON Parse error: Unexpected identifier "XXX"',
                        }[browser],
                    range: {
                        start: browser === 'safari' || browser === 'chrome'
                            ? { line: 0, character: 0 }
                            : { line: 1, character: 27 },
