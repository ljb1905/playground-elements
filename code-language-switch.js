...
let CodeLanguageSwitch = class CodeLanguageSwitch extends LitElement {
    constructor() {
        super(...arguments);
...
], CodeLanguageSwitch.prototype, "codeSwitchHanler", void 0);
CodeLanguageSwitch = __decorate([
    customElement('code-language-switch')
], CodeLanguageSwitch);
export { CodeLanguageSwitch };
